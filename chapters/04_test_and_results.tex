...
In sintesi, l'adozione di meccanismi di \textit{QoS} si rivela indispensabile per affrontare le sfide legate alla congestione e per ottimizzare le performance di rete.