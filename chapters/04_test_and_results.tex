...
In questa sezione vengono descritti i vari test effettuati. Per ciascun test, dopo una breve introduzione che illustra il lavoro svolto, segue una parte dedicata ai grafici dei risultati ottenuti, accompagnata da opportune considerazioni e analisi.
...
\begin{itemize}
    \item \textit{Congestione nulla}: assenza di QoS nei flussi dei dispositivi del \textit{Gruppo Tx} e assenza di congestione del canale, quindi il \textit{Gruppo Cx} sarà spento.
    \item \textit{Congestione parziale}: assenza di QoS nei flussi dei dispositivi del \textit{Gruppo Tx} e parziale congestione del canale, attuata mediante l'invio in broadcast di CAM da ognuno dei due dispositivi facenti parte del \textit{Gruppo Cx} ogni 5 ms.
    \item \textit{Congestione massima}: assenza di QoS nei flussi dei dispositivi del \textit{Gruppo Tx} e totale congestione del canale, attuata mediante trasmissione UDP in \textit{flooding} in broadcast da parte di ognuno dei due dispositivi del \textit{Gruppo Cx}.
\end{itemize}
...
Nei casi senza politiche di QoS sono stati utilizzati i medesimi comandi, senza ovviamente il parametro \verb|-A| che delinea le varie priorità.
...
\begin{figure}[h!]
    ...
    \includegraphics[width=1\textwidth]{t2_c0_main.png}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=1\textwidth]{t2_c1_main.png}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=1\textwidth]{t2_c2_main.png}
...
In conclusione, l'uso di diverse Access Categories non produce effetti positivi sulla variabilità del throughput in presenza di congestione, in quanto esso continua a oscillare come nel caso di mancato utilizzo di politiche di \textit{QoS}. L'unico effetto osservato è una maggiore velocità del flusso con priorità più alta, a discapito di quello con priorità più bassa.
\clearpage
\begin{table}[h!]
    \centering
